        ...
        for (var o = 0; o < e.length; o++) {
          ...
          if (r) {
            ...
            for (; a < n.parts.length; a++)
              r.parts.push(g(n.parts[a], t))
          } else {
            var l = [];
            for (a = 0; a < n.parts.length; a++)
              l.push(g(n.parts[a], t));
            i[n.id] = {
              id: n.id,
              refs: 1,
              parts: l
                ...
                if (t.length || e.content) {
                  ...
                  if (l ? o = l == this.id : 0 == this.allowUnformattedLog && (o = !1),
                    ...
                    if (e.date || (e.date = +new Date),
                        this.isReady) {
                      if (n.isString(t[0]) && (t[0] = t[0].replace(i, ""),
                        "" === t[0] && t.shift()),
                          !e.meta) {
                        var s = n.getDate(e.date);
                        e.meta = s.hour + ":" + s.minute + ":" + s.second
                      }
                      for (var u = r.default.render(a.default, {
                        logType: e.logType,
                        noMeta: !!e.noMeta,
                        meta: e.meta,
                        style: e.style || ""
                      }), f = r.default.one(".vc-item-content", u), v = 0; v < t.length; v++) {
                        var p = void 0;
                        try {
                          if ("" === t[v])
                            continue;
                      ...
                      n.isObject(e.content) && f.insertAdjacentElement("beforeend", e.content),
                        r.default.one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", u),
                        this.logNumber++,
                        this.limitMaxLogs(),
                ...
                return r.default.bind(r.default.one(".vc-fold-outer", s), "click", function(t) {
                  ...
                  return setTimeout(function() {
                    if (0 == i.children.length && e) {
                      ...
                      if (n.isObject(e)) {
                        var h, m = e.__proto__;
                        h = n.isObject(m) ? o.getFoldedLine(m, r.default.render(c.default, {
                          key: "__proto__",
                          keyType: "private",
          ...
          var v = function(e) {
            function t() {
              ...
              for (var n = arguments.length, r = new Array(n), a = 0; a < n; a++)
                r[a] = arguments[a];
              return (o = s(this, (e = u(t)).call.apply(e, [this].concat(r)))).tplTabbox = i.default,
